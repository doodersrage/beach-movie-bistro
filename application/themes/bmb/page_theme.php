...
namespace Application\Theme\Bmb;
...
class PageTheme extends \Concrete\Core\Page\Theme\Theme implements ThemeProviderInterface
{
    ...
    {
        return t('Beach Movie Bistro');
    }

    public function getThemeDescription()
    {
        return t('Custom theme for Virginia Beach, VA located Beach Movie Bistro.');
    }
    ...
    public function getThemeEditorClasses()
    {
        return array(
            ...
            array('title' => t('Red Text'), 'menuClass' => '', 'spanClass' => 'redText', 'forceBlock' => '-1'),
        );
    }
