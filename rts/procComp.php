...
if(is_string($_SESSION['data'])){
	...
	if($sess_data['rtsResult']['Packet']['Response']['ResponseText'] == 'OK'){
		...
		$message = '<html><body>';
		$message .= '<img src="https://beachmoviebistro.com/application/files/7114/6169/3563/beach-movie-bistro-logo.png" alt="#" class="ccm-image-block img-responsive bID-169">';
		...
		$message .= '<p><img src="https://beachmoviebistro.com/'.$sess_data['movieData']['photos']['photo'].'"></p>';
		...
		foreach($sess_data['rtsResult']['Packet']['Response']['Pickups']['Pickup']['BarCodes']['BarCode'] as $barcode){
			if($barcode['CodeType'] == 'UPC'){
				$message .= '<p><img alt="ticket barcode" src="https://beachmoviebistro.com/rts/barcode.php?text='.$barcode['BarCodeData'].'&size=40" /></p>';
